...
public interface IUserService {
     ...
     * @return IPage
     */
    IPage<UserDO> findUserDetail(UserDO user, QueryRequest request);
     ...
     * @return 用户信息
     */
    UserDO findUserDetail(String username);
     ...
     */
    void updateTheme(String username, String theme, int isTab);
     ...
     * @param user 个人信息
     */
    void updateProfile(UserDO user);
}
